...
// default latitude and longitude, Kolkata
var latitude = 22.5726;
var longitude = 88.3639;
...
function addMarker(place)
{
    ...
    var marker = new MarkerWithLabel({
        ...
        map: map,
        zIndex: parseInt(place.accuracy, 10)
    });
...
function configure()
{
    ...
    },
    {
        ...
        templates: {
            ...
            suggestion: _.template("<p><%- place_name %>, <%- admin_name1 %>&emsp;<i> <%- postal_code %> </i></p>")
        }
    });
